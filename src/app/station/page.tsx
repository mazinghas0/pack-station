    ...
    <main className="min-h-screen bg-black p-6">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center gap-4 mb-12">
          ...
          <div>
            <h1 className="text-3xl font-bold text-white">스테이션 선택</h1>
            <p className="text-gray-500">작업할 스테이션을 선택하세요</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
          {stations.map((station) => (
            <button
              ...
              className="group relative flex flex-col items-center gap-4 p-8 rounded-2xl border-2 transition-all duration-200 hover:scale-[1.02]"
              style={{
